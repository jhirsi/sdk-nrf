...
static void dect_nrf91_ctrl_mdm_mac_init(void)
{
...
void dect_nrf91_ctrl_mdm_on_modem_lib_init(int ret, void *ctx)
#else
NRF_MODEM_LIB_ON_INIT(dect_nrf91_ctrl_api_init_hook, dect_nrf91_ctrl_mdm_on_modem_lib_init, NULL);
static void dect_nrf91_ctrl_mdm_on_modem_lib_init(int ret, void *ctx)
#endif
{
	ARG_UNUSED(ret);
	ARG_UNUSED(ctx);

	dect_nrf91_ctrl_mdm_mac_init();
}
