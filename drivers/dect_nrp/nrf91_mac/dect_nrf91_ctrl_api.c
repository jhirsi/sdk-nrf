...
{
	struct dect_nrf91_ctrl_data *data = dect_nrf91_ctrl_internal_data_get();
	int channel;
...
{
	return (dect_nrf91_ctrl_get_ft_nw_beacon_state() == CTRL_FT_NW_BEACON_STATE_STARTED);
}

bool dect_nrf91_ctrl_api_mdm_activated(void)
{
	return (dect_nrf91_ctrl_get_mdm_activation_state() == CTRL_MDM_ACTIVATED);
}
...
int dect_nrf91_ctrl_api_mdm_configure_n_activate(void)
{
	...
	ret = dect_nrf91_ctrl_internal_modem_configure_req_from_settings();
	if (ret != 0) {
...
{
	int ret = dect_nrf91_ctrl_internal_mdm_deactivate_req();
...
int dect_nrf91_ctrl_api_mdm_reactivate(void)
{
	...
	if (dect_nrf91_ctrl_get_mdm_activation_state() != CTRL_MDM_ACTIVATED) {
...
int dect_nrf91_ctrl_api_rssi_scan_start_cmd(struct nrf_modem_dect_mac_rssi_scan_params *params)
{
	...
	return dect_nrf91_ctrl_internal_msgq_data_op_add(
...
int dect_nrf91_ctrl_api_tx_cmd(dect_nrf91_ctrl_api_tx_cmd_params_t *params)
{
	...
	if (data->total_unacked_req_amount >= DECT_MAC_DATA_TX_HANDLE_COUNT) {
...
int dect_nrf91_ctrl_api_cluster_start_req_cmd(struct dect_cluster_start_req_params *params)
{
	...
	if (dect_nrf91_ctrl_get_ft_cluster_state() != CTRL_FT_CLUSTER_STATE_NONE) {
...
int dect_nrf91_ctrl_api_cluster_reconfig_start_for_ipv6_prefix_cfg_changed(void)
{
	...
	return dect_nrf91_ctrl_internal_msgq_non_data_op_add(
...
int dect_nrf91_ctrl_api_nw_beacon_start_req_cmd(struct dect_nw_beacon_start_req_params *params)
{
	...
	if (dect_nrf91_ctrl_internal_nw_beacon_common_can_be_started(params->channel) == false) {
		return -EINVAL;
	}
	...
	if (dect_nrf91_ctrl_get_ft_nw_beacon_state() != CTRL_FT_NW_BEACON_STATE_NONE) {
...
int dect_nrf91_ctrl_api_nw_beacon_stop_req_cmd(struct dect_nw_beacon_stop_req_params *params)
{
	...
	ctrl_ft_nw_beacon_state_t nw_beacon_state = dect_nrf91_ctrl_get_ft_nw_beacon_state();
	...
	return dect_nrf91_ctrl_internal_msgq_non_data_op_add(DECT_NRF91_CTRL_OP_MDM_NW_BEACON_STOP);
}
...
int dect_nrf91_ctrl_api_network_create_req_cmd(void)
{
	...
	if (nw_beacon_channel != DECT_MAC_NW_BEACON_CHANNEL_NOT_USED &&
	    dect_nrf91_ctrl_internal_nw_beacon_common_can_be_started(
	...
	return dect_nrf91_ctrl_internal_msgq_non_data_op_add(DECT_NRF91_CTRL_OP_AUTO_START);
}
...
int dect_nrf91_ctrl_api_network_join_req_cmd(void)
{
	...
	if (dect_nrf91_ctrl_get_pt_association_state() == CTRL_PT_ASSOCIATION_STATE_ASSOCIATED) {
...
{
	return dect_nrf91_ctrl_internal_init(iface);
}
