...
#define CTRL_DATA_UNLOCK() k_mutex_unlock(&dect_mac_ctrl_data_mtx)
...
int dect_nrf91_ctrl_internal_msgq_data_op_add(
...
#endif /* DECT_NRF91_CTRL_INTERNAL_H */
