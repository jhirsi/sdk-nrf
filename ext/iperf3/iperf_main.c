...
int
iperf_main(int argc, char **argv, char* ram_file_ptr, int ram_file_len, struct k_poll_signal *kill_signal)
#else
int
...
#endif
{
    ...
    test->ram_file_ptr = ram_file_ptr;
    test->ram_file_len = ram_file_len;
