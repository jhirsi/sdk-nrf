...
/* 3.12 tag was used as a base when iperf3 was integrated to NRF Connect SDK: https://github.com/esnet/iperf/commits/3.12
 *
 */
#define PACKAGE_STRING "iperf 3.12-nrf"
#else
