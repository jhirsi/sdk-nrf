...
struct iperf_test
{
    ...
    int server_forced_idle_restarts_count;      /* count number of forced server restarts to make sure it is not stack */
    int server_forced_no_msg_restarts_count;    /* count number of forced server restarts to make sure it is not stack */
    int server_test_number;                     /* count number of tests performed by a server */
